...
def load_input(input_directory):
    """Funcion load_input"""
    sequence = [] # simila el flujo de entrada
...
def line_preprocessing(sequence):
    ...
    sequence = [
        ...
        #toma los simbolos de puntuacion y luego pasa a minuscula
...
def mapper(sequence):
    """Mapper"""
    #no importa el nombre del archivo sino su valor  (value)
...
def reducer(sequence):
    """Reducer"""
    result = []
    #clave : group - lista de tuplas de clave valor que contiene todos los elementos iguales
...
def create_ouptput_directory(output_directory):
    """Create Output Directory - garantiza una salida fresca"""
...
def create_marker(output_directory):
    """Create Marker
    success , en el momento es una carpeta vacia.
    en caso de que un proceso o trabajo falla el otro lo busca y sigue con el proceso"""
